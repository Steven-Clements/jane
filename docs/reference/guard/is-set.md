...
Checks whether a value is a *Set*. This helper performs a strict `instanceof` check and never throws or mutates input. It accepts native Set instances, Set subclasses, and wrapper objects created with `Object(...)`.
