...
Checks whether a value is a WeakMap. This helper performs a strict instanceof check and never throws or mutates input. It accepts native WeakMap instances, WeakMap subclasses, and wrapper objects created with Object(...).
...
- Use `validateWeakMap` if you need a `Result<V>` instead of a boolean.
