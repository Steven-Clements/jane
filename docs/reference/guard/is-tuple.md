...
Checks whether a value is a tuple of a specific structure. A tuple is defined as an array with a fixed length where each element satisfies a corresponding guard. This helper is fully structural and never throws or mutates input.
