...
Checks whether a value is a Map. This helper performs a strict instanceof check and never throws or mutates input. It accepts native Map instances, Map subclasses, and wrapper objects created with Object(...).
